...
namespace KopliSoft.Inventory
{
    public class Inventory : MonoBehaviour
    {
        ...
        public delegate bool ItemDelegate(Item item);
        ...
        public delegate void InventoryClosed(Inventory inv);
        public static event InventoryClosed InventoryClose;
        ...
        private void CheckIfAllInventoryClosed()
        {
            ...
            AllInventoriesClosed?.Invoke();
        }

        public bool ConsumeItem(Item item)
        {
            if (ItemConsumed != null) {
                return ItemConsumed(item);
            }
            return false;    
        }
