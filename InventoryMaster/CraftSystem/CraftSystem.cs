...
namespace KopliSoft.Inventory
{
    public class CraftSystem : MonoBehaviour
    {
        ...
        public void backToInventory()
        {
            ...
            {
                GameObject.FindGameObjectWithTag("InventoryController")
                    .GetComponent<InventoryController>()
                    .inventory
                    .GetComponent<Inventory>()
                    .addItemToInventory(itemInCraftSystem[i].itemID, itemInCraftSystem[i].itemValue);
        ...
        public void ListWithItem()
        {
            ...
            for (int k = 0; k < blueprintDatabase.blueprints.Count; k++)
            {
                ...
                for (int z = 0; z < blueprintDatabase.blueprints[k].ingredients.Count; z++)
                {
                    ...
                    if (amountOfTrue == blueprintDatabase.blueprints[k].ingredients.Count && amountOfTrue == itemInCraftSystem.Count)
                    {
